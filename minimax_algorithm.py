# This program implements that minimax algorithm
def best_moves(game_board, i , turn):
    if game_board[i] == game_board[i + 1] and game_board[i] == game_board[i + 2] and game_board[i] == turn:
        ...
        return True
    elif game_board[i + 1] == game_board[i + 4] and game_board[i + 1] == game_board[i + 7] and game_board[
        i + 1] == turn:
        return True
    elif game_board[i + 2] == game_board[i + 4] and game_board[i + 2] == game_board[i + 6] and game_board[
        i + 2] == turn:
        return True
    elif game_board[i + 2] == game_board[i + 5] and game_board[i + 2] == game_board[i + 8] and game_board[
        i + 2] == turn:
        return True
    elif game_board[i + 3] == game_board[i + 4] and game_board[i + 3] == game_board[i + 5] and game_board[
        i + 3] == turn:
        return True
    elif game_board[i + 6] == game_board[i + 7] and game_board[i + 6] == game_board[i + 8] and game_board[
        i + 6] == turn:
        return True
    else:
        return False
